...
{
      12,     0,    -1,     4,    13,     9,    10,    -1,     4,    13,
       6,     8,    10,    -1,     4,    13,     7,     8,    10,    -1,
      14,    13,    -1,    14,     5,    -1,     3,    -1
};
...
{
  "$end", "error", "$undefined", "exprex", "apare", "cpare", "letter", 
  "number", "atom_part", "empty", "NL", "$accept", "list", "aux", 
  "s_expression", 0
};
#endif
